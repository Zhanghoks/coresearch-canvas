                    ...
                    >
                        ...
                        <p className="mt-3 text-sm leading-6 text-stone-600 dark:text-stone-400">
                            {t("canvas.project.stats", {
                                nodes: project.canvasLoaded === false ? project.nodeCount : project.nodes.length,
                                connections: project.canvasLoaded === false ? project.connectionCount : project.connections.length,
                            })}
                        </p>
                    </button>
                )}
