...
description: Deploy CoResearch with Docker Compose
---

# Docker Deployment

This page runs the static web container. For sign-in and the hosted Pi Agent API, use [Hosted deployment](/docs/overview/hosted).
...
services:
  app:
    image: ghcr.io/zhanghoks/coresearch:latest
    ports:
      - "3000:3000"
    environment:
