...
import { useCanvasStore, workspaceCanvasProjects } from "@/stores/canvas/use-canvas-store";
...
export default function CanvasPage() {
    ...
    const projects = useMemo(() => workspaceCanvasProjects(allProjects), [allProjects, signedInUserId]);
