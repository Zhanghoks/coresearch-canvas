...
export function compactNode(node: CanvasNode) {
    ...
    if (typeof metadata.summary === "string" && metadata.summary.length > 240) metadata.summary = `${metadata.summary.slice(0, 120)}...`;
    if (typeof metadata.document === "string" && metadata.document.length > 240) metadata.document = `${metadata.document.slice(0, 120)}...`;
