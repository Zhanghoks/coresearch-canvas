export default {
    ...
    modelPlugin: {
        ...
        authoring: {
            intro: "请为 CoResearch 编写一段模型调用脚本。能力类型：{{capability}}。目标模型：{{model}}。",
    ...
    canvas: {
        defaultTitle: "研究项目 {{count}}",
        library: "研究项目",
        title: "CoResearch",
        imported: "已导入 {{count}} 个研究项目",
        importFailed: "导入失败，请选择有效的研究项目压缩包",
        opening: "正在打开研究项目...",
        loading: "正在加载研究项目...",
        exportSelected: "导出选中",
        deleteSelected: "删除选中",
        ...
        create: "新建研究",
        empty: "还没有研究项目",
        emptyDescription: "新建一个研究项目后，就可以在画布上组织节点、连线和研究外观。",
        recentProjects: "最近项目",
        collapsePanel: "收起面板",
        expandPanel: "展开面板",
        home: "主页",
        ...
        resetView: "重置视图",
        zoom: "放大/缩小画布",
        agentConnected: "本地 Agent 已连接",
        agentConnecting: "本地 Agent {{activity}}",
        agentDisconnected: "本地 Agent 未连接",
        connecting: "连接中",
        openAgent: "打开本地 Agent 面板",
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", video: "视频", audio: "音频", group: "组", seed: "Seed", direction: "Direction", research_question: "Research Question", problem: "Problem", hypothesis: "Hypothesis", approach: "Approach", method: "Method", evaluation: "Evaluation", idea: "Idea", frame: "框架", note: "便签", question: "问题", pdf: "PDF", web: "网页" },
        researchNodes: {
            summaryPlaceholder: "写一段摘要…",
            notePlaceholder: "写点什么…",
            questionPlaceholder: "想问什么？",
            questionHint: "此节点用于未来 Agent 问答绑定。",
            pdfPlaceholder: "粘贴 PDF 链接…",
            webPlaceholder: "粘贴网页链接…",
            sourceEmpty: "暂无来源链接",
            sourcePreview: "预览",
            sourceHidePreview: "收起预览",
            sourceOpen: "打开原文",
            sourceEditLink: "编辑链接",
            sourcePreviewLoading: "正在加载 PDF…",
            sourcePreviewUnavailable: "无法内嵌预览，请点「打开原文」查看",
            tryLabel: "试试：",
            tryWrite: "自己写摘要",
            tryAskAgent: "让 Agent 帮忙",
            statusConfirmed: "已确认",
            statusEmptyDocument: "文档空骨架",
            generateDirections: "生成方向地图",
            promptPlaceholder: "写下你想完善的内容、问题或方向。例如：把这个 Seed 收敛成一个更可检验的研究方向。",
            promptHint: "发送到 Agent",
            attachHint: "打开 Agent 附加参考",
            expandPrompt: "展开输入框",
            sendPrompt: "发送给 Agent",
            roles: {
                seed: "研究兴趣起点",
                direction: "值得深入的路线",
                research_question: "可追问的问题线索",
                problem: "要解决的核心问题",
                hypothesis: "可检验的解释",
                approach: "总体检验策略",
                method: "具体怎么做",
        ...
        emptyState: { title: "从一个研究问题开始", description: "把模糊兴趣放进画布，逐步形成方向、问题、方法与可验证的 Idea。", seed: "创建 Seed", seedDescription: "记录最初的研究兴趣", agent: "与 Agent 对话", agentDescription: "让 Agent 帮你展开第一步", hint: "也可以双击画布空白处创建研究节点" },
        project: {
            untitled: "未命名画布", imported: "导入画布",
            select: "选择 {{name}}", stats: "{{nodes}} 个节点 · {{connections}} 条连线", updated: "更新于 {{date}}", saveName: "保存名称", cancelRename: "取消重命名", export: "导出", rename: "重命名", delete: "删除", menu: "项目操作", copyPath: "复制路径", pathCopied: "路径已复制", showInFolder: "在文件管理器中显示", revealed: "已在文件管理器中打开", close: "关闭项目", actionFailed: "项目操作失败", browserOnlyWorkspace: "SaaS 模式下项目保存在当前浏览器，没有本机项目目录",
            deleteTitle: "删除画布？", deleteDescription: "将删除 {{count}} 个画布，里面的节点和连线也会一起移除。",
        },
        export: { defaultProjectName: "CoResearch", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
        ...
        sidePanel: {
            canvas: "画布元素", assets: "资产库", data: "研究数据", workspace: "研究工作区", startCreating: "开始创作", projectLibrary: "项目库", skillsConnectors: "技能 · 连接器", projects: "项目", workspaceName: "CoResearch 研究", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
            ...
            artifacts: "研究产物", noArtifacts: "当前项目还没有研究产物", dataConnectAgent: "连接 Research Agent 后显示当前项目数据", dataLoadFailed: "研究数据加载失败", dataReadFailed: "研究产物读取失败", sourceNodes: "{{count}} 个来源节点", conversationId: "对话", turnId: "运行轮次",
            artifactKinds: { "seed-brief": "Seed 摘要", "direction-map": "方向地图", "rq-comparison": "研究问题比较", "problem-evidence": "问题证据", "hypothesis-test-plan": "假设检验计划", "approach-tradeoff": "方案权衡", "method-protocol": "方法协议", "evaluation-matrix": "评估矩阵", "idea-review": "Idea 评审", "paper-plan": "论文大纲", "paper-draft": "论文草稿说明", "paper-audit": "论文审计", export: "导出文档" },
            filter: { image: "图片", video: "视频", text: "文本", audio: "音频", config: "配置", group: "分组", seed: "Seed", direction: "Direction", research_question: "Research Question", problem: "Problem", hypothesis: "Hypothesis", approach: "Approach", method: "Method", evaluation: "Evaluation", idea: "Idea", frame: "框架", note: "便签", question: "问题", pdf: "PDF", web: "网页" },
        },
        ...
        nodeToolbar: { noPrompt: "暂无可复制的提示词", noContent: "暂无可复制的内容", contentCopied: "已复制内容", copyContent: "复制内容", addToChat: "添加到对话", addedToChat: "已添加到对话", editDocument: "文本编辑", editDocumentTitle: "打开节点文档", documentTitle: "打开节点 Markdown 文档", document: "文档", infoTitle: "查看节点信息", info: "信息", removeTitle: "移除节点", retryTitle: "重新生成", queryVideoTask: "获取任务状态", queryVideoTaskTitle: "使用任务 ID 查询视频生成状态", videoTaskId: "任务 ID", saveAsset: "存资产", downloadAudio: "下载音频", downloadVideo: "下载视频", downloadImage: "下载图片", editTextTitle: "编辑文本", editText: "编辑文字", decreaseFont: "减小字号", increaseFont: "增大字号", zoomOut: "缩小", zoomIn: "放大", uploadImage: "上传图片", replaceVideo: "替换视频", uploadVideo: "上传视频", replaceAudio: "替换音频", uploadAudio: "上传音频", nodeInfo: "节点信息", name: "名称", type: "类型", size: "尺寸", position: "位置", status: "状态", imageGroup: "图片组", imageSize: "图片大小", group: "打组", groupTitle: "用组节点包住选中节点", ungroup: "解散组", ungroupTitle: "取消节点分组" },
        nodeTags: { title: "画布标签", hint: "画布标签会直接显示在画布上", keywords: "关键词", add: "添加", keywordPlaceholder: "输入关键词", removeKeyword: "点击移除", presets: { core: "核心", alt: "备选", lit: "文献", method: "方法", evidence: "证据", confirmed: "已确认", draft: "待定" } },
        nodeDocument: { markdown: "Markdown", preview: "预览", toc: "目录", completeScaffold: "补全骨架", placeholder: "在这里编写节点文档…", editorPlaceholder: "输入内容…", close: "关闭编辑", savedWithNode: "文档随当前画布节点保存在浏览器本地" },
    ...
    home: {
        heroQuestion: "你想研究什么？",
        heroPlaceholder: "描述你的研究兴趣、问题或假设，回车即可创建一份研究画布",
        openCanvas: "新建研究",
        showcaseTitle: "九种节点，拼出一条研究形成链",
        showcaseDescription: "从 Seed 到 Idea，每种节点回答研究形成里的一个问题；连线记录它们之间的推演关系。",
        groups: {
            all: "全部",
            exploration: "探索",
            reasoning: "推理",
        ...
        nodeTypes: {
            seed: "我想研究什么",
            direction: "有哪些值得走的方向",
            research_question: "这个方向里具体有哪些问题",
            problem: "我最终要解决的具体问题是什么",
            hypothesis: "我认为为什么 / 怎样可能解决",
            approach: "总体检验策略是什么",
            method: "具体怎么做",
            evaluation: "怎么证明它有效",
            idea: "现在形成了什么研究 Idea",
    ...
    config: {
        title: "配置",
        saasNoKeys: "模型由平台提供，无需填写 API Key。画布也不再提供生图、视频或音频生成。",
        ...
        localStorage: {
            ...
            description: "查看 CoResearch 在浏览器中保存的数据量，并按对象仓库统计内容体积。",
            ...
            mainDatabase: "CoResearch 主数据",
            records: "{{count}} 条",
            refresh: "刷新统计",
            readFailed: "读取本地存储失败",
            stores: { appState: "应用状态", images: "图片文件", imagePreviews: "图片缩略图", media: "音视频文件", imageLogs: "生图记录", videoLogs: "视频记录", agentMessages: "Agent 消息" },
        },
    ...
    agent: {
        ...
        siteTools: { canvasList: "画布列表", unknownTool: "未知工具：{{name}}", canvasLoading: "画布还在加载中，请稍后重试", canvasHint: "用 site_navigate 跳转 /canvas/{id} 打开对应画布" },
        connect: { title: "本地 Agent（开发）", description: "仅未启用托管 SaaS 或本机开发时使用：Canvas Agent 在线则自动发现连接。已登录 SaaS 用户走平台 agent-api，无需本页配置。", disconnect: "断开", connect: "连接", retry: "重试连接", autoPending: "正在自动连接本机 Agent…", modelsStatusTitle: "模型", modelsAutoHint: "在启动 Canvas Agent 的终端设置 OPENAI_API_KEY、ANTHROPIC_API_KEY 等，或写入 .data/auth.json；进程启动时会自动同步。", modelsReady: "已有可用模型，可直接对话。", modelsMissing: "尚未检测到可用模型。请为 Canvas Agent 配置 API Key 后重启进程。", statusAfterConnect: "连接成功后显示各提供商状态。", notConfigured: "未配置", manualConnect: "排查提示", manualHint: "确认已在终端运行 Canvas Agent（默认 http://127.0.0.1:17371）；开发模式下也可通过 Vite 代理 /__agent 访问。仍失败时查看 Agent 设置 → 日志。", searchTitle: "文献搜索", searchAutoHint: "arXiv 与网页搜索默认可用；Semantic Scholar 等可选密钥通过环境变量或 .data/search.json 配置。", searchNoKey: "无需密钥", searchUnset: "未配置", configured: "已配置", address: "连接地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现", manualConnectLegacy: "手动连接", hideManual: "收起", credentialsTitle: "模型 API Key", credentialsDescription: "", credentialsNeedConnection: "", credentialsMissing: "", provider: "提供商", providerPlaceholder: "", apiKey: "API Key", apiKeyPlaceholder: "", apiKeyReplace: "", saveKey: "保存密钥", removeKey: "移除密钥", keySaved: "密钥已保存", keyRemoved: "密钥已移除", searchDescription: "", searchNeedConnection: "", searchEmailPlaceholder: "填写邮箱", searchSaved: "搜索配置已保存", searchRemoved: "搜索配置已移除" },
        ...
        skillManager: {
            codexBusy: "Agent 正在运行，请完成当前任务后再提炼 Skill", noConversation: "当前对话还没有可提炼的已完成内容", noCanvas: "当前页面没有可提炼的画布", connecting: "当前页面仍在连接 Agent，请稍后再试", syncFailed: "同步当前画布失败，请检查 Agent 连接后重试", noDraft: "未生成 Skill 草稿", draftCreated: "草稿已生成，可在技能页确认后创建", draftFailed: "生成 Skill 草稿失败", contentMissing: "未读取到 Skill 内容", readFailed: "读取 Skill 失败", defaultPromptMention: "默认提示词需要包含 ${{name}}", created: "Skill 已创建", updated: "Skill 已更新", saveFailed: "保存 Skill 失败", deleteTitle: "删除 {{name}}", deleteDescription: "删除后本地文件无法恢复，确定继续吗？", delete: "删除", deleted: "Skill 已删除", deleteFailed: "删除 Skill 失败", statusFailed: "更新 Skill 状态失败",
            fromConversation: "从当前对话生成草稿", availableAfterRun: "Agent 运行结束后可用", conversationDescription: "整理当前对话中的可复用流程", noCompletedContent: "当前对话还没有已完成内容", startConversation: "请先开始一段对话", fromCanvas: "从当前画布生成草稿", canvasDescription: "整理当前页面的节点与生成流程", canvasUnavailable: "当前页面没有可用画布", blankCreate: "空白创建", blankDescription: "从空白表单开始编写", localSkills: "本地 Skill", localDescription: "来自当前项目 `.coresearch/skills`，由本地 Pi Agent 执行", reload: "重新读取", reloadSkill: "重新读取 Skill", createSkill: "创建 Skill", filterBySource: "按来源筛选 Skill", scopes: { all: "全部来源", repo: "项目", user: "个人", system: "系统", admin: "管理员" }, loadErrors: "{{count}} 个 Skill 未能加载", externalReadonly: "外部 Skill 只能使用或启停", noDescription: "暂无说明", enabled: "已启用", disabled: "已停用", selected: "已选择", use: "使用", editNamed: "编辑 {{name}}", deleteNamed: "删除 {{name}}", connectToView: "连接 Agent 后查看 Skill", noMatch: "没有匹配的 Skill", none: "还没有本地 Skill", connectDescription: "连接成功后会读取当前项目 Skill", tryAnotherFilter: "换个关键词或来源试试", createOrInstall: "创建一个，或放到项目 `.coresearch/skills` 后刷新", saveChanges: "保存更改", saveLocation: "保存到本地 Agent 工作区", basicInfo: "基本信息",
            identifier: "Skill 标识", identifierExtra: "用于文件夹名和 $skill-name 调用。", identifierRequired: "请输入 Skill 标识", identifierMax: "Skill 标识不能超过 64 个字符", identifierPattern: "仅支持小写字母、数字和连字符，连字符不能连续或位于首尾", identifierPlaceholder: "例如 product-grid", displayName: "显示名称", displayNameMax: "显示名称不能超过 64 个字符", displayNamePlaceholder: "例如 产品九宫格生成", whenToUse: "何时使用", whenToUseExtra: "说明这个 Skill 的能力和适用场景，Agent 会据此判断是否调用。", whenToUseRequired: "请输入使用场景", whenToUseMax: "使用场景不能超过 1024 个字符", noAngleBrackets: "使用场景不能包含尖括号", whenToUsePlaceholder: "例如：当用户需要基于商品信息规划并生成一组产品图时使用", instructions: "执行说明", instructionsExtra: "按实际执行顺序写清步骤、约束和输出要求。", instructionsRequired: "请输入执行说明", instructionsPlaceholder: "写清楚执行步骤、必要检查和最终输出", advanced: "高级设置", shortDescription: "卡片短说明", shortDescriptionExtra: "填写时控制在 25–64 个字符，便于快速浏览。", shortDescriptionMin: "卡片短说明不能少于 25 个字符", shortDescriptionMax: "卡片短说明不能超过 64 个字符", shortDescriptionPlaceholder: "可选，用于列表展示", defaultPrompt: "默认提示词", defaultPromptExtra: "填写时必须准确包含 $skill-name，例如 $product-grid。", defaultPromptMax: "默认提示词不能超过 1024 个字符", defaultPromptPlaceholder: "可选，选择 Skill 时预填到输入框",
        },
        composer: { removeImage: "移除图片", removeReference: "移除引用", removeSkill: "移除 Skill", uploadImage: "上传图片", stop: "停止", send: "发送", model: "模型：{{model}}", selectModel: "选择模型，当前为 {{model}}", reasoning: "思考程度：{{effort}}", selectReasoning: "选择思考程度，当前为 {{effort}}", permissionLabel: "权限：{{mode}}", selectPermission: "选择权限模式，当前为 {{mode}}", effort: { off: "关闭", minimal: "最低", low: "轻度", medium: "中", high: "高", xhigh: "极高", max: "最高", ultra: "Ultra" }, permission: { request: "请求批准", requestDescription: "编辑工作区外文件或联网时始终询问", automatic: "自动审查", automaticDescription: "由 Agent 审查风险操作，必要时再询问", full: "完全访问权限", fullShort: "完全访问", fullDescription: "不受限制地访问网络和本机文件" }, tools: { label: "工具确认：{{mode}}", manual: "手动确认", manualDescription: "Agent 执行画布写入前会请求确认", automatic: "自动确认", automaticDescription: "Agent 会自动执行画布写入操作", select: "选择工具确认模式，当前为 {{mode}}" }, mentions: { selectSkill: "选择 Skill", selectResource: "引用画布素材", loadingSkills: "正在读取 Skill…", noSkills: "没有匹配的已启用 Skill", noResources: "当前画布没有匹配的可引用素材", previewUnavailable: "当前无法预览该素材", referenceLabel: "引用{{kind}}：{{title}}", resourceMissing: "画布素材“{{title}}”已不存在", imageReadFailed: "无法读取画布图片“{{title}}”", kind: { image: "图片", video: "视频", audio: "音频", text: "文本" } } },
        panel: { connectionSettings: "连接设置 · {{status}}", connectionSettingsLabel: "连接设置，当前{{status}}", chat: "对话", connection: "状态", settings: "Agent 设置", settingsLabel: "打开 Agent 设置", settingsTitle: "Agent 设置", history: "历史", historyLabel: "打开历史记录", skills: "技能", logs: "日志", collapse: "收起对话", collapseLabel: "收起 Agent 面板", resize: "调整右侧面板宽度", content: "Agent 内容", mcpInitializing: "正在初始化本地 Agent，完成后即可发送", preparing: "正在初始化本地 Agent，完成后即可发送", initFailed: "本地 Agent 对话初始化失败，请新建或恢复对话", needApiKey: "尚未检测到可用模型，请为 Canvas Agent 配置 API Key（环境变量或 .data/auth.json）后重启", placeholder: "询问本地 Agent，输入 / 使用技能，@ 引用画布素材", documentAgent: "文本 Agent", documentPlaceholder: "想让整篇更出彩？告诉我目标、语气或篇幅" },
        source: { paper: "论文", repo: "仓库", drag: "拖到画布" },
        direction: { kind: "方向 D{{index}}", thread: "脉络 {{index}}" },
        chat: { welcome: "你好，{{name}}", welcomeDescription: "从当前研究项目开始，我们一起把想法放到画布上。", documentWelcome: "你好，{{name}}", documentWelcomeDescription: "通过对话创作、改写和完善「{{title}}」的文本内容", documentWelcomeHint: "你可以直接告诉我整篇内容想怎么调整，也可以指出某一段，做更精准的修改。", documentHelpTitle: "我可以帮你：", documentHelpRewrite: "创作与改写：重写段落、补全骨架、调整节奏", documentHelpPolish: "润色与整理：扩写、缩写或重新组织内容", documentHelpLocal: "精修选区：根据某一段做更精准的修改", documentHelpFull: "修改全文：直接说明整篇目标，例如压缩篇幅或改成更可检验的表述", latestMessages: "查看最新消息", latestCall: "最新调用", input: "输入", cached: "缓存", output: "输出" },
        ...
        eventMore: { toolRunning: "{{action}}中…", openedRoute: "已打开{{route}}", canvasCount: "共 {{count}} 个画布", assetCount: "共 {{count}} 个资产", assetAdded: "已加入我的素材", generationStatus: "共 {{total}} 个任务，排队 {{queued}}，运行中 {{running}}，成功 {{succeeded}}，失败 {{failed}}", workbenchExecuted: "已在工作台执行", workbenchConfigRead: "已读取工作台配置", canvasRead: "已读取当前画布内容", selectionRead: "已读取当前选中内容", textNodes: "{{count}} 个文本", imageNodes: "{{count}} 张图片", configNodes: "{{count}} 个配置", videoNodes: "{{count}} 个视频", audioNodes: "{{count}} 个音频", groupNodes: "{{count}} 个分组", otherNodes: "{{count}} 个其他节点", connections: "{{count}} 条连线", emptyCanvas: "当前画布为空", executeTool: "执行{{tool}}", thinking: "正在思考...", operationRunning: "{{operation}}正在进行...", organizingCanvas: "画布已读取，Agent 正在整理结果...", operationCompleted: "{{operation}}已完成，Agent 正在继续处理...", attachmentPrompt: "请处理上传的图片附件。", routes: { home: "首页", canvas: "画布页面", canvasProject: "指定画布", config: "配置页面" } },
        runtime: {
            mcpStarting: "正在启动 MCP：{{name}}", mcpConnecting: "正在建立工具连接并读取可用工具列表", mcpReadyNamed: "MCP 已就绪：{{name}}", toolsReady: "工具列表加载完成，可以开始对话", mcpFailedNamed: "MCP 启动失败：{{name}}", mcpCanceledNamed: "MCP 启动已取消：{{name}}", toolInitFailed: "工具服务未能完成初始化", mcpServicesStarting: "正在启动 MCP 服务", toolServicesPending: "还有 {{count}} 个工具服务正在初始化", checkingToolServices: "正在确认工具服务状态", conversationInitializing: "正在初始化本地 Agent 对话", conversationCreating: "正在创建会话并启动画布工具服务", someMcpFailed: "部分 MCP 服务初始化失败", remainingToolsReady: "其余工具已就绪，可以开始对话", conversationInitFailed: "本地 Agent 对话初始化失败", conversationCreateFailed: "无法创建本地 Agent 会话", mcpServicesReady: "{{count}} 个 MCP 服务已完成初始化", toolInitCanceled: "工具服务初始化已取消", mcpStatusComplete: "MCP 状态确认完成", mcpListRead: "已读取完整工具服务清单",
            historyReadFailed: "读取历史失败", conversationSyncFailed: "同步会话失败", agentOutdated: "本地 Agent 版本过旧，请重启 Canvas Agent 后重新连接", restartRequired: "需要重启 Agent", versionMismatch: "Agent 版本不匹配", awaitingApproval: "等待权限确认", codexRunning: "本地 Agent 正在运行", connected: "已连接", localAgentConnected: "本地 Agent 已连接", processingFailed: "处理失败", completed: "完成", approvalGranted: "已批准权限", approvalCanceled: "已取消权限", log: "日志", connectionLostDescription: "本地 Agent 连接失败或已断开", connectionFailedDescription: "连接失败，请检查地址和 token", connectionLost: "连接断开", connectionFailed: "连接失败", modelListFailed: "读取模型列表失败",
            imageTooLarge: "图片过大", imagePayloadTooLarge: "图片附件超过 30MB，请删减后再发送。", imagesSent: "发送了 {{count}} 张图片", canvasReferencesSent: "引用了 {{count}} 个画布素材", someCanvasReferencesMissing: "部分引用的画布素材已不存在", canvasReferencesMissing: "引用的画布素材已不存在，请重新选择", readingCanvasImages: "正在读取画布图片", canvasImageReadFailed: "画布图片读取失败", tooManyImages: "图片数量过多", imageCountLimit: "上传图片和引用的画布图片合计最多 {{count}} 张。", sending: "发送中", rollingBack: "正在回退对话", rolledBack: "已回退，准备重新发送", rollbackFailed: "回退对话失败", defaultModel: "默认模型", defaultEffort: "默认强度", sendTask: "发送任务", attachmentCount: "附件 {{count}}", canvasReferenceCount: "画布素材 {{count}}", attachmentsOnly: "仅附件", canvasReferencesOnly: "画布素材", startConversationFailed: "启动对话失败", attachmentHistoryFailed: "保存附件历史失败", sendFailed: "发送失败", conversationSynced: "会话已同步", taskStillRunning: "任务仍在运行", stopping: "停止中", stopTask: "停止任务", taskStopped: "任务已停止", stopFailed: "停止失败", imageLimit: "图片附件最多约 30MB。", imageReadFailed: "图片读取失败", pendingCanvasTool: "仍有待确认的画布工具调用", awaitingConfirmation: "等待确认", toolCompleted: "{{tool}}完成", toolExecutionFailed: "工具执行失败", openCanvasFirst: "当前不在画布页，请先用 site_navigate 打开画布", canvasOperationFailed: "画布操作失败", canvasToolCanceled: "用户取消了画布工具调用",
            submittingApproval: "正在提交权限决定", waitingCodexApproval: "等待权限确认", approvalFailed: "权限审批失败", enableFullAccess: "启用完全访问权限", fullAccessDescription: "Agent 将不受沙箱限制，可访问互联网及本机任意文件。请仅在信任当前任务时使用。", enableFullAccessAction: "启用完全访问", offline: "离线", addressRequired: "请填写本地 Agent 地址", agentNotFound: "没有发现本地 Agent，请先启动 Canvas Agent", invalidAddress: "本地 Agent 地址格式不正确", connecting: "连接中", creatingConversation: "正在新建对话", newConversation: "新对话", newConversationFailed: "新建对话失败", conversationResumed: "已恢复会话", resumeConversationFailed: "恢复对话失败", recordsDeleted: "已删除 {{count}} 条记录", deleteConversationFailed: "删除对话失败", deleteConversations: "删除 {{count}} 条对话记录", deleteConversationsDescription: "删除后无法恢复，确定继续吗？", importGeneratedImages: "导入生成图片", addedToSourceCanvas: "已添加到发起任务的画布", imageGenerated: "图片已生成", noImageAttachments: "没有可添加的图片附件", invalidAttachmentNode: "图片附件节点参数无效", attachmentReadFailed: "读取图片附件失败", referenceImage: "参考图", generatedImageReadFailed: "读取生成图片失败", generatedImageName: "生成图片 {{index}}",
        },
    },
    auth: { title: "登录 CoResearch", inviteTitle: "使用邀请码注册", gateDescription: "研究画布需要登录后使用", nickname: "昵称", password: "密码", signIn: "登录", register: "创建账号", signOut: "退出登录", signedIn: "已登录", needInvite: "用邀请码注册", backToSignIn: "已有账号？登录", inviteCode: "邀请码", failed: "认证失败" },
    locale: {
        zhCN: "简体中文",
        enUS: "English",
    },
