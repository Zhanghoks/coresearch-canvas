---
name: open-canvas
description: 打开 CoResearch 本地画布，并自动连接本地 Canvas Agent。用户要求打开、启动、进入或使用研究画布时使用。
---

# Open CoResearch Canvas

默认打开本仓库本地前端。只有用户明确要求其他部署地址时，才改用自定义 URL。

## 本地版

1. 在 CoResearch 项目中启动前端，并使用 Vite 输出的 `Local` 地址：
