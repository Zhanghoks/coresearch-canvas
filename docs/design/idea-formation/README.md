...
| 步骤 | 文档 | 当前对齐情况 |
|---|---|---|
| 1 · Seed Framing | [01-seed.md](./01-seed.md) | 已对齐：Seed 独立、轻量；确认与启动探索分开 |
| 2 · Direction Exploration | [03-direction-focus.md](./03-direction-focus.md) | 已对齐：coverage-first、Direction Polish、选择后才 Deep Dive |
| 3 · Direction Deep Dive | [02-research-landscape.md](./02-research-landscape.md) | 已对齐：对选中 Direction 重建 Paper Section 证据和 Research Map |
| 4 · Research Question Formation | 尚无独立文档 | 新步骤；RQ 从 Paper Section 派生，支持 Ask / Targeted Search / Polish；禁止随手标记 Open Gap |
| 5 · Evaluation Exploration | 尚无独立文档 | 新步骤；从 RQ 形成 Evaluation Targets 和 Strategy，不先设计 Method |
| 6 · Method Exploration | 尚无独立文档 | 新步骤；在评价策略明确后形成 Method Candidates |
| 7 · Research Design Co-Design | [07-research-design.md](./07-research-design.md) | Claim ↔ Method ↔ Evaluation 联合收敛；Problem / Hypothesis / Approach 作为设计层 |
| 8–10 · Idea Draft / Review / Versioning | [08-idea-synthesis-review.md](./08-idea-synthesis-review.md) | 按新流程拆开草稿、审查和版本循环；Review 不打分 |
