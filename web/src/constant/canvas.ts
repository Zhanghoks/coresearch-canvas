...
import type { CanvasNodeMetadata, ResearchFlowNodeType } from "@/types/canvas";
import { getNodeSpec as getRegistryNodeSpec } from "@/lib/canvas/node-registry";
import { researchDocumentSkeleton } from "@research-headings";
    ...
    return {
        ...
        get metadata() {
            return {
                ...
                summary: "",
                document: researchDocumentSkeleton(type as ResearchFlowNodeType, NODE_DEFAULT_SIZE[type].title),
            };
        },
    };
}
...
export const NODE_DEFAULT_SIZE = {
    ...
    [CanvasNodeType.Seed]: nodeSize(CanvasNodeType.Seed, 280, 420),
    [CanvasNodeType.Direction]: nodeSize(CanvasNodeType.Direction, 280, 420),
    [CanvasNodeType.ResearchQuestion]: nodeSize(CanvasNodeType.ResearchQuestion, 280, 420),
    [CanvasNodeType.Problem]: nodeSize(CanvasNodeType.Problem, 280, 420),
    [CanvasNodeType.Hypothesis]: nodeSize(CanvasNodeType.Hypothesis, 280, 420),
    [CanvasNodeType.Approach]: nodeSize(CanvasNodeType.Approach, 280, 420),
    [CanvasNodeType.Method]: nodeSize(CanvasNodeType.Method, 280, 420),
    [CanvasNodeType.Evaluation]: nodeSize(CanvasNodeType.Evaluation, 280, 420),
    [CanvasNodeType.Idea]: nodeSize(CanvasNodeType.Idea, 280, 420),
