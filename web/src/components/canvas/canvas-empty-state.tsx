import { ArrowUpRight, Bot, Sprout } from "lucide-react";
...
export const CanvasEmptyState = memo(function CanvasEmptyState({ onAddNode, onOpenAgent }: { onAddNode: (type: CanvasNodeTypeId) => void; onOpenAgent: () => void }) {
