export default {
    meta: {
        title: "CoResearch",
        description: "A research canvas tool",
    },
    ...
    modelPlugin: {
        ...
        authoring: {
            intro: "Write a model request script for CoResearch. Capability: {{capability}}. Target model: {{model}}.",
    ...
    assets: {
        ...
        fields: {
            ...
            source: "Source",
            sourcePlaceholder: "Added manually / Canvas",
            note: "Note",
            optional: "Optional",
    ...
    canvas: {
        defaultTitle: "Research Project {{count}}",
        library: "Research projects",
        title: "CoResearch",
        imported: "Imported {{count}} projects",
        importFailed: "Import failed. Select a valid project package.",
        ...
        emptyDescription: "Create a research project to organize nodes, connections, and appearance on its canvas.",
        ...
        agentConnecting: "Local Agent {{activity}}",
        agentDisconnected: "Local Agent disconnected",
        connecting: "Connecting",
        openAgent: "Open local Agent panel",
        nodeTypes: { image: "Image", text: "Text", config: "Generation config", video: "Video", audio: "Audio", group: "Group", seed: "Seed", direction: "Direction", research_question: "Research Question", problem: "Problem", hypothesis: "Hypothesis", approach: "Approach", method: "Method", evaluation: "Evaluation", idea: "Idea", frame: "Frame", note: "Note", question: "Question", pdf: "PDF", web: "Web" },
        researchNodes: {
            summaryPlaceholder: "Write a one-line summary…",
            notePlaceholder: "Write a note…",
            questionPlaceholder: "What do you want to ask?",
            questionHint: "This node is for future Agent Q&A binding.",
            pdfPlaceholder: "Paste a PDF link…",
            sourcePreview: "Preview",
            sourceHidePreview: "Hide preview",
            sourceOpen: "Open source",
            sourceEditLink: "Edit link",
            sourcePreviewLoading: "Loading PDF…",
            sourcePreviewUnavailable: "Inline preview unavailable. Use “Open source” instead.",
            webPlaceholder: "Paste a web link…",
            sourceEmpty: "No source link yet",
            tryLabel: "Try:",
            tryWrite: "Write the summary myself",
            tryAskAgent: "Ask the Agent for help",
            statusConfirmed: "Confirmed",
            statusEmptyDocument: "Empty document scaffold",
            generateDirections: "Generate direction map",
            promptPlaceholder: "Write what you want to refine—a question, scene, or direction. Example: turn this Seed into a more testable research direction.",
            promptHint: "Send to Agent",
            attachHint: "Open Agent to attach references",
            expandPrompt: "Expand input",
            sendPrompt: "Send to Agent",
            roles: {
                seed: "Starting research interest",
                direction: "A path worth pursuing",
                research_question: "A question thread to chase",
                problem: "The core problem to solve",
                hypothesis: "A testable explanation",
                approach: "Overall testing strategy",
                method: "How you will do it",
                evaluation: "How you know it worked",
                idea: "A versionable research claim",
            },
        },
        toolbar: {
        ...
        emptyState: { title: "Start from a research interest", description: "Capture a fuzzy interest on the canvas and grow it into directions, questions, methods, and a verifiable Idea.", seed: "Create Seed", seedDescription: "Record the initial research interest", agent: "Chat with Agent", agentDescription: "Let the Agent help with the first step", hint: "Or double-click empty canvas to create a research node" },
        project: {
            untitled: "Untitled canvas", imported: "Imported canvas",
            select: "Select {{name}}", stats: "{{nodes}} nodes · {{connections}} connections", updated: "Updated {{date}}", saveName: "Save name", cancelRename: "Cancel rename", export: "Export", rename: "Rename", delete: "Delete", menu: "Project actions", copyPath: "Copy path", pathCopied: "Path copied", showInFolder: "Show in file manager", revealed: "Opened in file manager", close: "Close project", actionFailed: "Project action failed", browserOnlyWorkspace: "In SaaS mode, projects live in this browser only; there is no local project folder",
            deleteTitle: "Delete canvases?", deleteDescription: "This will delete {{count}} canvases along with their nodes and connections.",
        },
        export: { defaultProjectName: "CoResearch", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
        ...
        sidePanel: {
            ...
            artifacts: "Research artifacts", noArtifacts: "This project has no research artifacts yet", dataConnectAgent: "Connect Research Agent to view this project's data", dataLoadFailed: "Could not load research data", dataReadFailed: "Could not read this artifact", sourceNodes: "{{count}} source nodes", conversationId: "Conversation", turnId: "Run turn",
            artifactKinds: { "seed-brief": "Seed brief", "direction-map": "Direction map", "rq-comparison": "Research question comparison", "problem-evidence": "Problem evidence", "hypothesis-test-plan": "Hypothesis test plan", "approach-tradeoff": "Approach trade-off", "method-protocol": "Method protocol", "evaluation-matrix": "Evaluation matrix", "idea-review": "Idea review", "paper-plan": "Paper plan", "paper-draft": "Paper draft note", "paper-audit": "Paper audit", export: "Export document" },
            filter: { image: "Image", video: "Video", text: "Text", audio: "Audio", config: "Configuration", group: "Group", seed: "Seed", direction: "Direction", research_question: "Research Question", problem: "Problem", hypothesis: "Hypothesis", approach: "Approach", method: "Method", evaluation: "Evaluation", idea: "Idea", frame: "Frame", note: "Note", question: "Question", pdf: "PDF", web: "Web" },
        },
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", noContent: "Nothing to copy yet", contentCopied: "Content copied", copyContent: "Copy content", addToChat: "Add to conversation", addedToChat: "Added to conversation", editDocument: "Edit text", editDocumentTitle: "Open node document", documentTitle: "Open node Markdown document", document: "Document", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", queryVideoTask: "Get task status", queryVideoTaskTitle: "Query video generation status by task ID", videoTaskId: "Task ID", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size", group: "Group", groupTitle: "Wrap selected nodes in a group", ungroup: "Ungroup", ungroupTitle: "Remove grouping from selected nodes" },
        nodeTags: { title: "Canvas tags", hint: "Canvas tags appear directly on the canvas", keywords: "Keywords", add: "Add", keywordPlaceholder: "Type a keyword", removeKeyword: "Click to remove", presets: { core: "Core", alt: "Alt", lit: "Literature", method: "Method", evidence: "Evidence", confirmed: "Confirmed", draft: "Draft" } },
        nodeDocument: { markdown: "Markdown", preview: "Preview", toc: "Contents", completeScaffold: "Complete scaffold", placeholder: "Write this node's document…", editorPlaceholder: "Start writing…", close: "Close editor", savedWithNode: "The document is stored locally with this canvas node" },
    ...
    navigation: {
        ...
        agentSettings: "Agent connection",
        agentSkills: "Skills",
    ...
    home: {
        heroQuestion: "What do you want to research?",
        heroPlaceholder: "Describe your research interest, question, or hypothesis, then press Enter to create a research canvas",
        openCanvas: "New research",
        showcaseTitle: "Nine node types make a research formation chain",
        showcaseDescription: "From Seed to Idea, each node answers one question in research formation; connections record how they build on each other.",
        groups: {
            all: "All",
            exploration: "Explore",
            reasoning: "Reason",
        ...
        nodeTypes: {
            seed: "What do I want to study?",
            direction: "Which directions are worth pursuing?",
            research_question: "What concrete questions sit inside this direction?",
            problem: "What specific problem will I solve?",
            hypothesis: "Why or how might it be solved?",
            approach: "What is the overall testing strategy?",
            method: "How will I actually do it?",
            evaluation: "How will I show that it works?",
            idea: "What research idea have I formed?",
        },
    },
    config: {
        title: "Settings",
        saasNoKeys: "Models are provided by the platform. You do not enter an API key, and the canvas no longer generates images, video, or audio.",
        ...
        localStorage: {
            ...
            description: "View browser data saved by CoResearch, grouped by object store.",
            ...
            mainDatabase: "CoResearch data",
            records: "{{count}} records",
            refresh: "Refresh usage",
            readFailed: "Failed to read local storage",
            stores: { appState: "App state", images: "Image files", imagePreviews: "Image thumbnails", media: "Audio and video files", imageLogs: "Image history", videoLogs: "Video history", agentMessages: "Agent messages" },
        },
    ...
    agent: {
        ...
        siteTools: { canvasList: "Canvas list", unknownTool: "Unknown tool: {{name}}", canvasLoading: "The canvas is still loading. Try again shortly.", canvasHint: "Use site_navigate to open /canvas/{id}" },
        connect: { title: "Local Agent (dev)", description: "For local development only. Signed-in SaaS users talk to the hosted agent-api—no setup here. When Canvas Agent runs locally, URL and token are discovered automatically.", disconnect: "Disconnect", connect: "Connect", retry: "Retry connection", autoPending: "Connecting to the local Agent automatically…", modelsStatusTitle: "Models", modelsAutoHint: "Set OPENAI_API_KEY, ANTHROPIC_API_KEY, and similar variables in the terminal where you start Canvas Agent, or use .data/auth.json. Keys sync on Agent startup.", modelsReady: "Models are available. You can chat now.", modelsMissing: "No models detected yet. Configure API keys for Canvas Agent and restart the process.", statusAfterConnect: "Provider status appears after connection.", notConfigured: "Not configured", manualConnect: "Troubleshooting", manualHint: "Make sure Canvas Agent is running (default http://127.0.0.1:17371). In dev, Vite proxies /__agent. If it still fails, check Agent settings → Logs.", searchTitle: "Literature search", searchAutoHint: "arXiv and web search work by default; optional keys use environment variables or .data/search.json.", searchNoKey: "No key required", searchUnset: "Not configured", configured: "Configured", address: "Connection URL", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discovered automatically", manualConnectLegacy: "Manual connection", hideManual: "Hide", credentialsTitle: "Model API keys", credentialsDescription: "", credentialsNeedConnection: "", credentialsMissing: "", provider: "Provider", providerPlaceholder: "", apiKey: "API key", apiKeyPlaceholder: "", apiKeyReplace: "", saveKey: "Save key", removeKey: "Remove key", keySaved: "API key saved", keyRemoved: "API key removed", searchDescription: "", searchNeedConnection: "", searchEmailPlaceholder: "Enter an email", searchSaved: "Search settings saved", searchRemoved: "Search settings removed" },
