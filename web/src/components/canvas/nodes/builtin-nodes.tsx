...
const BUILTIN_DEFINITIONS: CanvasNodeDefinition[] = [
    ...
    const type = def.type as CanvasNodeType;
    const spec = NODE_SPECS[type];
    return { ...def, title: spec.title, defaultSize: { width: spec.width, height: spec.height }, get defaultMetadata() { return NODE_SPECS[type].metadata; } };
});
