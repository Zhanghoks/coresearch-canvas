---
title: Docker 部署
description: 使用 Docker Compose 部署 CoResearch
---

# Docker 部署

如果你希望在自己的机器上跑静态前端，可以直接使用 Docker Compose。带登录和托管 Pi 的生产部署见 [托管部署](/docs/overview/hosted)。
...
docker run -d -p 3000:3000 \
  ...
  ghcr.io/zhanghoks/coresearch:latest
```
